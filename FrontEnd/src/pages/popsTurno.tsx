            ...
            >
                ...
                <Modal.Body css={{ fontSize: "16px", color: "#000000" }}>
                    ...
                    <Text css={{ fontSize: "18px", fontFamily: "DM Sans", color: "#000000", fontWeight: "700", textAlign: "center" }}>
                        Tu turno con Peluquería Flores es el día 15/03/23 a las 12:30 hs
                    </Text>
                    <Text css={{ fontSize: "14px", fontFamily: "DM Sans", color: "#000000", fontWeight: "400", textAlign: "center" }}>En las 48 hs previas a tu turno recibirás un correo de recordatorio para confirmarlo.
                    </Text>
                    <Text css={{ fontSize: "14px", fontFamily: "DM Sans", color: "#000000", fontWeight: "400", textAlign: "center" }}>
